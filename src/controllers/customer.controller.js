...
const {getAllCustomer, createCustomer, createArrayCustomer, updateCustomer} = require("../services/customer.service");
...
module.exports = {GetCustomersAPI, CreateCustomersAPI, CreateManyCustomersAPI, UpdateCustomersAPI};